...
List<Restaurants> restaurantsFromJson(dynamic data) {
    return List<Restaurants>.from(data.map((x) => Restaurants.fromJson(x)));
}
    ...
    factory Restaurants.fromJson(Map<String, dynamic> json){
        try{
          return  Restaurants(
            ...
            throw Exception("Error parsing restaruants ");
        }
    }
