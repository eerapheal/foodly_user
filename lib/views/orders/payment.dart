...
class _PaymentWebViewState extends State<PaymentWebView> {
  ...
  // Call this method before disposing or removing the WebView
            ...
            orderController.paymentUrl = '';
              if(kIsWeb){
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) =>  SuccessfulWeb()));
              }else{
                Navigator.push(context,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        toolbarHeight: 70,
        title: Text(Get.find<OrderController>().paymentMethod=="Stripe"?"Stripe payment":"Paystack payment"),
      ),
