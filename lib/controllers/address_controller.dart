  ...
  void addAddress(String address) async {
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        final double lat = data['coordinates']['latitude'];
        final double lng = data['coordinates']['longitude'];
        ...
        print("Wrong response ${response.body}");
        var data = apiErrorFromJson(response.body);

        Get.snackbar(data.message, "Failed to add address1, please try again",
            colorText: kLightWhite,
      ...
      Get.snackbar(e.toString(), "Failed to add address2, please try again",
          colorText: kLightWhite,
          backgroundColor: kRed,
          icon: const Icon(Icons.error));
    } finally {
